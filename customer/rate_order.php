        ...
        <div class="rate-card">
            ...
            <?php if ($already_rated): ?>
                ...
                <div class="rate-actions">
                    <a class="rate-btn-primary" href="<?php echo $base_path; ?>/customer/reviews.php?order_id=<?php echo $order_id; ?>">View Your Review</a>
                    <a class="rate-btn-secondary" href="<?php echo $base_path; ?>/customer/orders.php?tab=completed">Back to Orders</a>
                </div>
            <?php else: ?>
                ...
                <form method="POST" enctype="multipart/form-data" id="ratingForm" onsubmit="handleSubmit(this)">
                    ...
                    <div class="rate-actions">
                        ...
                        <a class="rate-btn-secondary" href="<?php echo $base_path; ?>/customer/orders.php?tab=completed">Skip for now</a>
                    </div>
                </form>
            <?php endif; ?>
        </div>
