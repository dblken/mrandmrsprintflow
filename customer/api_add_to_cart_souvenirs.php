...
function souvenir_redirect_url(string $path, array $query = []): string {
...
echo json_encode([
    'success' => true,
    'item_key' => $item_key,
    'redirect_url' => souvenir_redirect_url('/customer/order_review.php', ['item' => $item_key]),
    'cart_url' => souvenir_redirect_url('/customer/cart.php'),
]);
