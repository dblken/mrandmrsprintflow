                    ...
                    <div class="profile-avatar-wrap">
                        <div class="profile-avatar-ring">
                            <?php if (!empty($customer['profile_picture'])): ?>
                                <img src="<?php echo $base_path; ?>/public/assets/uploads/profiles/<?php echo htmlspecialchars($customer['profile_picture']); ?>?t=<?php echo time(); ?>" alt="Avatar" id="profile-preview">
                            <?php else: ?>
