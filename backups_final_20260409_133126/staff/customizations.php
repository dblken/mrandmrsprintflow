                            ...
                            <div style="display:flex; gap:20px; align-items:flex-start;">
                                <div style="width:160px; flex-shrink:0;">
                                    <template x-if="currentJo.payment_proof_path">
                                        <a :href="'<?php echo $base_path; ?>//printflow/api_view_proof.php?file=' + encodeURIComponent(currentJo.payment_proof_path)"
                                           target="_blank" rel="noopener noreferrer"
                                           style="display:block;line-height:0;">
                                            <img :src="'<?php echo $base_path; ?>//printflow/api_view_proof.php?file=' + encodeURIComponent(currentJo.payment_proof_path)"
