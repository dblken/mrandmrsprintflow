    ...
    <div class="main-content">
        <header>
            ...
            <div style="display:flex;gap:8px;align-items:center;">
                <button type="button" id="pf-push-toggle" class="btn-secondary mobile-hidden" style="height:38px;padding:0 16px;font-size:13px;display:inline-flex;align-items:center;gap:6px;">
