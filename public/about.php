...
<!-- ============================================================
     HERO
     ============================================================ -->
<section class="lp-mini-hero overflow-x-hidden w-full max-w-full" style="padding-top:0; padding-bottom:3rem; md:padding-bottom:5rem;">
    <?php $nav_header_class = 'lp-hero-nav sticky top-0 z-50'; require __DIR__ . '/../includes/nav-header.php'; ?>
    <div class="lp-mini-hero-inner px-4 sm:px-6 w-full max-w-full" style="padding-top:4rem;">
        <div class="lp-wrap px-4 sm:px-6 w-full max-w-full text-center md:text-left flex flex-col items-center md:items-start">
            <p class="lp-hero-tag" style="margin-bottom:1.5rem;">✦ Our Story</p>
            <h1 class="text-3xl sm:text-4xl md:text-6xl leading-tight break-words max-w-full" style="font-weight:800; color:#fff; letter-spacing:-0.03em; margin-bottom:1.25rem; line-height:1.1;">
                <?php echo $tagline; ?>
            </h1>
            <p class="text-sm md:text-base break-words max-w-full" style="color:var(--lp-muted); max-width:640px; margin:0 auto 2.5rem; md:margin:0 0 2.5rem; line-height:1.7;">
...
<!-- ============================================================
     STATS BAR
     ============================================================ -->
<section class="overflow-x-hidden w-full max-w-full py-12 md:py-20" style="background:var(--lp-bg2); border-bottom:1px solid var(--lp-border);">
    <div class="lp-wrap px-4 sm:px-6 w-full max-w-full">
...
<!-- ============================================================
     MISSION & VISION
     ============================================================ -->
<section class="lp-section overflow-x-hidden w-full max-w-full py-12 md:py-20">
    <div class="lp-wrap px-4 sm:px-6 w-full max-w-full">
        <div style="text-align:center; margin-bottom:3.5rem;">
            <p class="lp-heading-label">Who We Are</p>
            <h2 class="lp-heading text-3xl sm:text-4xl md:text-5xl" style="font-size:clamp(1.9rem,4vw,2.8rem);">Purpose-Driven <span style="color:var(--lp-accent-l);">Printing</span></h2>
            <p class="lp-heading-desc text-sm md:text-base break-words">Our mission and vision guide every product we produce and every client we serve.</p>
        </div>

        <div class="flex flex-col md:flex-row gap-6 md:gap-8">
            <!-- Mission -->
            <div class="w-full break-words" style="flex:1; background:var(--lp-surface); border:1px solid rgba(83,197,224,0.15); border-radius:1.25rem; padding:2.5rem; position:relative; overflow:hidden;">
                ...
                <h3 class="text-xl md:text-2xl break-words" style="font-size:1.4rem; font-weight:700; color:#fff; margin-bottom:1rem;">Our Mission</h3>
                <p class="text-sm md:text-base break-words" style="color:var(--lp-muted); line-height:1.8; font-size:1rem;"><?php echo $mission; ?></p>
            </div>
            ...
            <div class="w-full break-words" style="flex:1; background:var(--lp-surface); border:1px solid rgba(83,197,224,0.15); border-radius:1.25rem; padding:2.5rem; position:relative; overflow:hidden;">
                ...
                <h3 class="text-xl md:text-2xl break-words" style="font-size:1.4rem; font-weight:700; color:#fff; margin-bottom:1rem;">Our Vision</h3>
                <p class="text-sm md:text-base break-words" style="color:var(--lp-muted); line-height:1.8; font-size:1rem;"><?php echo $vision; ?></p>
            </div>
        </div>
    </div>
</section>
...
<!-- ============================================================
     ...
     ============================================================ -->
<?php if (!empty($values)): ?>
<section class="lp-section-light py-12 md:py-20 w-full max-w-full overflow-x-hidden">
    <div class="lp-wrap px-4 sm:px-6 w-full max-w-full">
        <div style="text-align:center; margin-bottom:3.5rem;">
            ...
            <h2 class="text-3xl sm:text-4xl md:text-5xl leading-tight" style="font-weight:800; color:#fff; letter-spacing:-0.025em; margin-bottom:1rem;">Our Core <span style="color:var(--lp-accent);">Values</span></h2>
            <p class="text-sm md:text-base break-words" style="color:var(--lp-muted); max-width:520px; margin:0 auto; line-height:1.7;">The principles that guide every print, every project, every promise we make to you.</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8" style="display:grid; grid-template-columns:repeat(auto-fill, minmax(250px, 1fr)); gap:1.5rem;">
            <?php foreach ($values as $v): ?>
            <div class="p-4 md:p-6 break-words" style="background:var(--lp-surface); border:1px solid rgba(83,197,224,0.15); border-radius:1.25rem; padding:2rem; box-shadow:0 2px 12px rgba(0,0,0,0.2); transition:transform .2s, box-shadow .2s;"
                ...
                <h3 class="text-base md:text-lg break-words" style="font-weight:700; color:#fff; margin-bottom:.5rem;"><?php echo htmlspecialchars($v['title']); ?></h3>
                <p class="text-xs md:text-sm break-words" style="color:var(--lp-muted); line-height:1.6;"><?php echo htmlspecialchars($v['desc']); ?></p>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<section class="lp-section py-12 md:py-20 w-full max-w-full overflow-x-hidden">
    <div class="lp-wrap px-4 sm:px-6 w-full max-w-full">
        <div style="text-align:center; margin-bottom:3.5rem;">
            <p class="lp-heading-label">The People Behind the Prints</p>
            <h2 class="lp-heading text-3xl sm:text-4xl md:text-5xl leading-tight">Meet Our <span style="color:var(--lp-accent-l);">Team</span></h2>
            <p class="lp-heading-desc text-sm md:text-base break-words">Passionate professionals dedicated to making your printing experience seamless and outstanding.</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 text-center" style="display:flex; flex-wrap:wrap; gap:1.75rem; justify-content:center;">
            <?php foreach ($team_members as $tm): ?>
            <div class="flex flex-col items-center" style="text-align:center; max-width:240px; width:100%; margin:0 auto;">
                ...
                <?php else: ?>
                    <div class="w-20 h-20 md:w-28 md:h-28 rounded-full bg-[var(--lp-surface)] border-3 border-[var(--lp-accent)] flex items-center justify-center mx-auto mb-4"
                         style="width:100px; height:100px; border-radius:50%; background:var(--lp-surface); border:3px solid var(--lp-accent); margin:0 auto 1rem; display:flex; align-items:center; justify-content:center;">
                        <svg class="w-10 h-10 md:w-14 md:h-14 text-[var(--lp-muted)]" style="width:48px; height:48px; color:var(--lp-muted);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                        </svg>
                    </div>
                <?php endif; ?>
                <h4 class="text-sm md:text-lg font-bold break-words" style="color:#fff; margin-bottom:.25rem;"><?php echo htmlspecialchars($tm['name']); ?></h4>
                <p class="text-xs md:text-sm break-words" style="color:var(--lp-accent-l);"><?php echo htmlspecialchars($tm['role']); ?></p>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<section class="lp-section-light py-12 md:py-20 w-full max-w-full overflow-x-hidden">
    <div class="lp-wrap px-4 sm:px-6 w-full max-w-full">
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center" style="display:grid; grid-template-columns:1fr 1fr; gap:4rem; align-items:center;">
            <div class="w-full text-center lg:text-left">
                ...
                <h2 class="text-3xl sm:text-4xl md:text-5xl leading-tight" style="font-weight:800; color:#fff; letter-spacing:-0.025em; margin-bottom:1.5rem; line-height:1.15;">Built on <span style="color:var(--lp-accent);">Quality</span>,<br>Driven by <span style="color:var(--lp-accent);">Results</span></h2>
                <p class="text-sm md:text-base break-words" style="color:var(--lp-muted); line-height:1.8; margin-bottom:1.75rem;">
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start" style="display:flex; gap:1rem; flex-wrap:wrap;">
            ...
            <div class="w-full grid grid-cols-1 sm:grid-cols-2 gap-4" style="display:flex; flex-direction:column; gap:1rem;">
                <?php $perks = [
                ...
                <div class="p-4 md:p-6 break-words" style="display:flex; gap:1rem; align-items:flex-start; padding:1.25rem; background:var(--lp-surface); border:1px solid rgba(83,197,224,0.15); border-radius:1rem; box-shadow:0 1px 6px rgba(0,0,0,0.2);">
                    ...
                    <div>
                        <div class="text-base md:text-lg font-bold break-words" style="color:#fff; margin-bottom:.2rem;"><?php echo $perk['title']; ?></div>
                        <div class="text-xs md:text-sm break-words" style="color:var(--lp-muted); line-height:1.6;"><?php echo $perk['desc']; ?></div>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
...
<!-- ============================================================
     CTA
     ============================================================ -->
<section class="lp-section-cta py-12 md:py-20 w-full max-w-full overflow-x-hidden">
    <div class="lp-wrap px-4 sm:px-6 w-full max-w-full">
        <div class="lp-cta-inner text-center p-6 md:p-12">
            <h2 class="lp-cta-title text-2xl sm:text-3xl md:text-4xl break-words leading-tight">Ready to Start Your Next Print Project?</h2>
            <p class="lp-cta-desc text-sm md:text-base break-words mt-4">Join thousands of happy clients who trust <?php echo $shop_name; ?> for all their printing needs.</p>
            <div class="flex flex-col sm:flex-row gap-3 justify-center mt-8" style="">
                <?php if (!is_logged_in()): ?>
