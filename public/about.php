...
<section class="lp-mini-hero overflow-x-hidden" style="padding-top:0; padding-bottom:3rem;">
    ...
    <div class="lp-mini-hero-inner px-4 sm:px-6" style="padding-top:4rem;">
        <div class="lp-wrap px-4 sm:px-6" style="text-align:center;">
            <p class="lp-hero-tag" style="margin-bottom:1.5rem;">✦ Our Story</p>
            <h1 class="text-4xl md:text-6xl leading-tight break-words" style="font-weight:800; color:#fff; letter-spacing:-0.03em; margin-bottom:1.25rem;">
                <?php echo $tagline; ?>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center items-center w-full sm:w-auto mx-auto">
...
<section class="overflow-x-hidden py-12 md:py-20" style="background:var(--lp-bg2); border-bottom:1px solid var(--lp-border);">
    <div class="lp-wrap px-4 sm:px-6">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
            <div>
                <div class="text-2xl md:text-4xl" style="font-weight:800; color:var(--lp-accent); line-height:1;"><?php echo $founding_year; ?></div>
            ...
            <div>
                <div class="text-2xl md:text-4xl" style="font-weight:800; color:var(--lp-accent); line-height:1;"><?php echo $team_size; ?></div>
            ...
            <div>
                <div class="text-2xl md:text-4xl" style="font-weight:800; color:var(--lp-accent); line-height:1;"><?php echo $projects_done; ?></div>
            ...
            <div>
                <div class="text-2xl md:text-4xl" style="font-weight:800; color:var(--lp-accent); line-height:1;"><?php echo $happy_clients; ?></div>
...
<section class="lp-section overflow-x-hidden py-12 md:py-20">
    <div class="lp-wrap px-4 sm:px-6">
        <div style="text-align:center; margin-bottom:3.5rem;">
            ...
            <h2 class="lp-heading text-3xl md:text-5xl">Purpose-Driven <span style="color:var(--lp-accent-l);">Printing</span></h2>
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="w-full break-words" style="background:var(--lp-surface); border:1px solid rgba(83,197,224,0.15); border-radius:1.25rem; padding:1.5rem md:padding:2.5rem; position:relative; overflow:hidden;">
                ...
                <p class="text-sm md:text-base" style="color:var(--lp-muted); line-height:1.8;"><?php echo $mission; ?></p>
            </div>
            ...
            <div class="w-full break-words" style="background:var(--lp-surface); border:1px solid rgba(83,197,224,0.15); border-radius:1.25rem; padding:1.5rem md:padding:2.5rem; position:relative; overflow:hidden;">
                ...
                <p class="text-sm md:text-base" style="color:var(--lp-muted); line-height:1.8;"><?php echo $vision; ?></p>
            </div>
        </div>
    </div>
</section>
...
<section class="lp-section-light overflow-x-hidden py-12 md:py-20">
    <div class="lp-wrap px-4 sm:px-6">
        <div style="text-align:center; margin-bottom:3.5rem;">
            ...
            <h2 class="text-3xl md:text-5xl" style="font-weight:800; color:#fff; letter-spacing:-0.025em; margin-bottom:1rem;">Our Core <span style="color:var(--lp-accent);">Values</span></h2>
            <p style="font-size:1.0625rem; color:var(--lp-muted); margin:0 auto; line-height:1.7;" class="max-w-[520px] w-full mx-auto">The principles that guide every print, every project, every promise we make to you.</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php foreach ($values as $v): ?>
            <div class="p-6 md:p-8 break-words" style="background:var(--lp-surface); border:1px solid rgba(83,197,224,0.15); border-radius:1.25rem; box-shadow:0 2px 12px rgba(0,0,0,0.2); transition:transform .2s, box-shadow .2s;"
                ...
                <h3 class="text-lg font-bold text-white mb-2"><?php echo htmlspecialchars($v['title']); ?></h3>
                <p class="text-sm text-[var(--lp-muted)] leading-relaxed"><?php echo htmlspecialchars($v['desc']); ?></p>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<section class="lp-section overflow-x-hidden py-12 md:py-20">
    <div class="lp-wrap px-4 sm:px-6">
        <div style="text-align:center; margin-bottom:3.5rem;">
            ...
            <h2 class="lp-heading text-3xl md:text-5xl">Meet Our <span style="color:var(--lp-accent-l);">Team</span></h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div style="margin:0 auto;" class="flex flex-col items-center text-center max-w-[240px] w-full">
                <?php if (!empty($tm['photo'])): ?>
                    <img src="<?php echo $base_path; ?>/public/assets/uploads/team/<?php echo htmlspecialchars($tm['photo']); ?>"
                         class="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-4 border-[var(--lp-accent)] mb-4">
                <?php else: ?>
                    <div class="w-24 h-24 md:w-32 md:h-32 rounded-full bg-[var(--lp-surface)] border-4 border-[var(--lp-accent)] flex items-center justify-center mb-4">
                        <svg class="w-12 h-12 md:w-16 md:h-16 text-[var(--lp-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                        </svg>
                    </div>
                <?php endif; ?>
                <h4 class="text-lg font-bold text-white mb-1"><?php echo htmlspecialchars($tm['name']); ?></h4>
                <p class="text-sm text-[var(--lp-accent-l)]"><?php echo htmlspecialchars($tm['role']); ?></p>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <div class="lp-wrap px-4 sm:px-6">
        <div class="flex flex-col md:flex-row gap-12 items-center">
            <div class="w-full text-center md:text-left">
                ...
                <h2 class="text-3xl md:text-5xl" style="font-weight:800; color:#fff; letter-spacing:-0.025em; margin-bottom:1.5rem; line-height:1.15;">Built on <span style="color:var(--lp-accent);">Quality</span>,<br>Driven by <span style="color:var(--lp-accent);">Results</span></h2>
            ...
            <div class="w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="p-6 break-words flex gap-4 items-start" style="background:var(--lp-surface); border:1px solid rgba(83,197,224,0.15); border-radius:1rem; box-shadow:0 1px 6px rgba(0,0,0,0.2);">
                    ...
                    <div>
                        <div class="text-sm md:text-base font-bold text-white mb-1"><?php echo $perk['title']; ?></div>
                        <div class="text-[13px] text-[var(--lp-muted)] leading-relaxed"><?php echo $perk['desc']; ?></div>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
...
<section class="lp-section-cta overflow-x-hidden py-12 md:py-20">
    <div class="lp-wrap px-4 sm:px-6">
        <div class="lp-cta-inner text-center py-12 px-6">
            <h2 class="text-3xl md:text-5xl font-bold text-white mb-4">Ready to Start Your Next Print Project?</h2>
            <p class="text-sm md:text-lg text-[var(--lp-muted)] mb-8">Join thousands of happy clients who trust <?php echo $shop_name; ?> for all their printing needs.</p>
