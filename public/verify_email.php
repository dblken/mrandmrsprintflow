...
<div class="card">
    ...
    <form method="POST" action="<?php echo $base_path; ?>/public/verify_otp.php" id="otp-form">
        <?php echo csrf_field(); ?>
    ...
    <p class="back-link">Wrong email? <a href="<?php echo $base_path; ?>/index.php?auth_modal=register">Register again</a></p>
