                ...
                <div class="card">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data" id="profileForm">
                            ...
                            <div class="relative group">
                                <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-xl bg-gray-100 flex items-center justify-center">
                                    <?php if (!empty($user['profile_picture'])): ?>
                                        <img src="<?php echo $base_path; ?>/public/assets/uploads/profiles/<?php echo htmlspecialchars($user['profile_picture']); ?>?t=<?php echo time(); ?>" 
                        ...
                        <div style="background:#f9fafb; border:1px solid #e5e7eb; border-radius:8px; padding:16px; margin-bottom:16px;">
                            ...
                            <img src="<?php echo $base_path; ?>/uploads/id_validation.png" alt="Valid vs Invalid ID" style="max-width:100%; height:auto; border-radius:6px; margin-bottom:12px;">
                        ...
                        <div style="margin-bottom:16px;">
                            ...
                            <div><a href="<?php echo $base_path; ?>/uploads/ids/<?php echo htmlspecialchars($user['id_validation_image']); ?>" target="_blank" rel="noopener" style="color:#0d9488; font-weight:600;">View ID Image</a></div>
