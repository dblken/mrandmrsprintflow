    ...
    <div class="main-content" x-data="{ filterOpen: false, activeStatus: '<?php echo $_GET['status'] ?? 'ALL'; ?>', activeRange: '<?php echo $range; ?>', hasActiveFilters: <?php echo (($_GET['status']??'ALL') !== 'ALL' || $range !== 'week') ? 'true' : 'false'; ?> }">
        <header>
            ...
            <div class="toolbar-group">
                ...
                <!-- PDF Report Button -->
                <a href="export_order_summary_pdf.php?range=<?php echo $range; ?>&status=<?php echo $_GET['status'] ?? 'ALL'; ?>" class="toolbar-btn" style="background:#ef4444; border-color:#ef4444; color:#fff;">
