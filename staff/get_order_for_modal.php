...
foreach ($items as $item) {
    ...
    $items_out[] = [
        ...
        'design_url'      => (!empty($item['design_image']) || !empty($item['design_file']))
            ? '<?php echo $base_path; ?>/public/serve_design.php?type=order_item&id=' . (int)$item['order_item_id'] : null,
        'reference_url'   => !empty($item['reference_image_file'])
            ? '<?php echo $base_path; ?>/public/serve_design.php?type=order_item&id=' . (int)$item['order_item_id'] . '&field=reference' : null,
    ];
}
